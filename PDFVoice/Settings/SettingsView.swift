        ...
        NavigationStack {
            List {
                ...
                Section {
                    ...
                    Text("Голос по умолчанию")
                } footer: {
                    // Голос теперь выбирается ПО КНИГЕ (пикер в читалке) — эти два
                    // пикера задают только дефолт для книг, где выбор ещё не сделан.
                    Text("Действует для книг, где голос не выбран вручную. Голос конкретной книги меняется в читалке.")
                }
